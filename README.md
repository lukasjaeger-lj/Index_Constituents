...
In order to run the code:
  ...
  5) Enter timeframe of investigation in format YYYY-MM-DD in line 55 (start) and 56 (end);
  6) Set your own directory in line 59;
  7) Add variables of your choice in line 191 (Refinitiv Workspace > Search "Data Item Browser");
  8) Run the code (if you have not yet installed the API, use pip install lseg-data).
